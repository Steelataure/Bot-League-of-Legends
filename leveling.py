...
background = PhotoImage(file='degrad.png')
...
vide = Frame(None)
vide.pack(pady=25)
Champion_prioritaire = Entry(width=30, font='Arial', borderwidth=4, bg='#C829DD')
...
Go = Button(text="Utiliser le Bot", width=20, font='ArialBlack', borderwidth=5, command=Champion_saisi,
            bg='#268BE1')
Go.pack()
...
interface.bind('<Escape>', quit)  # Quitter (programme entier) avec Echap
interface.protocol('WM_DELETE_WINDOW', Croix)  # Quitter avec la croix rouge
interface.mainloop()
